...
const UpdateSearch = (props) => {
	...
	useEffect(() => {
		setTotalRSVP(
			parseFloat(chicken) + parseFloat(steak) + parseFloat(vegetarian)
		)
				...
				<ul className='updated-search-list'>
					<div key={initialItem._id}>
						<div className='update-search-list-initial-items'>
							<h3>
								{initialItem.familyName} Family of {initialItem.membersInvited}{" "}
								selected{" "}
							</h3>
						...
						<div className='updated-search-list-items'>
							<div className='updated-search-list-item'>
								...
								<button
									...
									onClick={() =>
										setSteak((Steak) => {
											if (Steak < initialItem.membersInvited) {
												return Steak + 1
											}
											return Steak
										})
							...
							<div className='updated-search-list-item'>
								...
								<button
									...
									onClick={() =>
										setChicken((Chicken) => {
											if (Chicken < initialItem.membersInvited) {
												return Chicken + 1
											}
											return Chicken
										})
							...
							<div className='updated-search-list-item'>
								...
								<button
									...
									onClick={() =>
										setVegetarian((Vegetarian) => {
											if (Vegetarian < initialItem.membersInvited) {
												return Vegetarian + 1
											}
											return Vegetarian
										})
							...
							<div className='updated-search-list-item'>
								...
								<p className='declines' id='declines' name='Declines'>
									{decline}{" "}
								</p>
							</div>
							{totalRSVP > initialItem.membersInvited && (
								<div className='alert alert-danger'>
									{" "}
									You currently have {totalRSVP} members attending while only{" "}
									{initialItem.membersInvited} were invited{" "}
								</div>
							)}
						</div>
						<div className='btn-container'>
							...
							<button
								...
								onClick={() => updateRSVP(initialItem)}
								disabled={totalRSVP > initialItem.membersInvited ? true : false}
							>
								{" "}
								Save{" "}
							</button>
